...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 1274356719
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMenu_Statics::NewProp_HostButton_MetaData[] = {
		{ "BindWidget", "" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// the Button Name of c++ should coincide with blueprint.\n" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Menu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "the Button Name of c++ should coincide with blueprint." },
#endif
	};
#endif
	...
	UMenu::~UMenu() {}
	struct Z_CompiledInDeferFile_FID_Unreal_Projects_Blaster_Plugins_MutiplayerSessions_Source_MutiplayerSessions_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Blaster_Plugins_MutiplayerSessions_Source_MutiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 1466576379U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Blaster_Plugins_MutiplayerSessions_Source_MutiplayerSessions_Public_Menu_h_2635664890(TEXT("/Script/MutiplayerSessions"),
		Z_CompiledInDeferFile_FID_Unreal_Projects_Blaster_Plugins_MutiplayerSessions_Source_MutiplayerSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_Blaster_Plugins_MutiplayerSessions_Source_MutiplayerSessions_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
